...
public class FactureReglement {
    ...
    public Integer getIdFactureReglement() { return idFactureReglement; }
    public void setIdFactureReglement(Integer idFactureReglement) { this.idFactureReglement = idFactureReglement; }

    public Integer getIdFacture() { return idFacture; }
    public void setIdFacture(Integer idFacture) { this.idFacture = idFacture; }

    public Integer getIdReglement() { return idReglement; }
    public void setIdReglement(Integer idReglement) { this.idReglement = idReglement; }

    public BigDecimal getMontantAffecte() { return montantAffecte; }
    public void setMontantAffecte(BigDecimal montantAffecte) { this.montantAffecte = montantAffecte; }
